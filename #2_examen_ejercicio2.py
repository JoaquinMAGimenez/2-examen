...
#aristas
g.insertar_arista('C-3PO','Yoda', 1)
g.insertar_arista('C-3PO','princesa Leila', 1)
g.insertar_arista('C-3PO','Luke Skywalker', 8)
g.insertar_arista('C-3PO','Darth Vader', 0)
g.insertar_arista('C-3PO','Boba Fett', 0)
g.insertar_arista('C-3PO','Rey', 1)
g.insertar_arista('C-3PO','Kylo Ren', 10)
g.insertar_arista('C-3PO','Chewbacca', 1)
g.insertar_arista('C-3PO','Han Solo', 1)
g.insertar_arista('C-3PO','R2-D2', 2)
g.insertar_arista('C-3PO','Obi-Wan Kenobi', 4)
g.insertar_arista('C-3PO','BB-8', 0)

g.insertar_arista('Yoda','C-3PO', 1)
...
g.insertar_arista('princesa Leila','C-3PO', 1)
...
g.insertar_arista('Luke Skywalker','C-3PO', 8)
...
g.insertar_arista('Darth Vader','C-3PO', 0)
...
g.insertar_arista('Boba Fett','C-3PO', 0)
...
g.insertar_arista('Kylo Ren','C-3PO', 10)
...
g.insertar_arista('Chewbacca','C-3PO', 0)
...
g.insertar_arista('R2-D2','C-3PO', 2)
...
g.insertar_arista('Obi-Wan Kenobi','C-3PO', 4)
...
g.insertar_arista('BB-8','C-3PO', 0)
...
#c
cant_de_capitulos_mayores_que_2 = Grafo.cantidad_de_capitulos_mayores_que_2()
print('los personajes que se relacionaron en mas de 2 capitulos son:',cant_de_capitulos_mayores_que_2)
#e
